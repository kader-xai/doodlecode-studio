...
const ROWS: { keys: string; what: string; when?: string }[] = [
  ...
  { keys: "→ / Space / PageDown", what: "Next slide — or next frame on an animation cell, then the slide", when: "presenting" },
  ...
  { keys: "＋ Animate", what: "Add an animation cell (frame-by-frame reveals; 🎞 chip cycles the transition)", when: "anywhere" },
